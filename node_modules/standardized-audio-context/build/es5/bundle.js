(function (global, factory) {
    ...
    var createAddAudioWorkletModule = function createAddAudioWorkletModule(createAbortError, createNotSupportedError, evaluateSource, exposeCurrentFrameAndCurrentTime, fetchSource, getBackupNativeContext, getNativeContext, ongoingRequests, resolvedRequests, window) {
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function MediaElementAudioSourceNode(context, options) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaElementAudioSourceNode).call(this, context, true, nativeMediaElementAudioSourceNode, null)); // Bug #63: Edge does not expose the mediaElement yet.
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    commonNativePannerNodeOptions = _objectSpread$p({}, commonAudioNodeOptions, {
                    ...
                    if ('bufferSize' in nativePannerNode) {
                      nativeGainNode = createNativeGainNode(nativeOfflineAudioContext, _objectSpread$p({}, commonAudioNodeOptions, {
                        gain: 1
                      }));
                    } else if (!nativePannerNodeIsOwnedByContext) {
                      options = _objectSpread$p({}, commonNativePannerNodeOptions, {
                        ...
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            ...
                            case 9:
                              ...
                              inputGainNode = createNativeGainNode(nativeOfflineAudioContext, _objectSpread$p({}, commonAudioNodeOptions, {
                                gain: 1
                              }));
                              _context3.next = 13;
                            ...
                            case 13:
                              ...
                              gateGainNode = createNativeGainNode(nativeOfflineAudioContext, _objectSpread$p({}, commonAudioNodeOptions, {
                                gain: 1
                              }));
                              partialPannerNode = createNativePannerNode(nativeOfflineAudioContext, _objectSpread$p({}, commonNativePannerNodeOptions, {
      ...
      return (
        ...
        function () {
          function PeriodicWave(context, options) {
            ...
            var mergedOptions = _objectSpread$q({}, DEFAULT_OPTIONS$h, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function StereoPannerNode(context) {
            ...
            var mergedOptions = _objectSpread$r({}, DEFAULT_OPTIONS$i, {}, options);
      ...
      return (
        ...
        function (_audioNodeConstructor) {
          ...
          function WaveShaperNode(context) {
            ...
            var mergedOptions = _objectSpread$s({}, DEFAULT_OPTIONS$j, {}, options);
    ...
    var addAudioWorkletModule = isSecureContext ? createAddAudioWorkletModule(createAbortError, createNotSupportedError, createEvaluateSource(window$1), exposeCurrentFrameAndCurrentTime, createFetchSource(createAbortError), getBackupNativeContext, getNativeContext, new WeakMap(), new WeakMap(), // @todo window is guaranteed to be defined because isSecureContext checks that as well.
    window$1) : undefined;
