...
export interface IMinimalBaseAudioContext<T extends TContext> extends TNativeEventTarget {
    ...
    addEventListener<K extends keyof IMinimalBaseAudioContextEventMap>(type: K, listener: (this: this, event: IMinimalBaseAudioContextEventMap[K]) => void, options?: boolean | AddEventListenerOptions): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof IMinimalBaseAudioContextEventMap>(type: K, listener: (this: this, event: IMinimalBaseAudioContextEventMap[K]) => void, options?: boolean | EventListenerOptions): void;
    removeEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | EventListenerOptions): void;
}
//# sourceMappingURL=/build/es2019/interfaces/minimal-base-audio-context.d.ts.map